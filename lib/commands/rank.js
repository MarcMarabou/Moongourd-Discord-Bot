        ...
        request('https://moongourd.com/eu/hiscores?area=' + dungeon + '&boss=' + boss + '&class=' + lookup + '&filter=nh&euc=' + euc + '&slay=' + slay, function (error, response, body) {
            ...
            if (content != null) {
                ...
                const fields = [
                    ...
                    { 'name': 'Server', 'value': (lookup == 'All Classes') ? content[4] : content[3], 'inline': true }, 
                    { 'name': 'Rank', 'value': content[1], 'inline': true }, 
                    { 'name': 'DPS', 'value': (lookup == 'All Classes') ? content[6] : content[5] }, 
                    { 'name': 'Run', 'value': '[Moongourd Link](https://moongourd.com/eu/' + ((lookup == 'All Classes') ? content[5] : content[4]) + ')' }
                ];
